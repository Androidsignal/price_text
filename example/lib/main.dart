      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            PriceText(
              currencyType: CurrencyType.INR, //for currency type to be displayed
              ...
              customFlagWidget: Image.asset('assets/india.png', width: 40, height: 40,fit: BoxFit.cover,), //custom flag widget if you want to show custom flag
              currencyCodeText: 'India', //custom currency code text if you want to show custom text
